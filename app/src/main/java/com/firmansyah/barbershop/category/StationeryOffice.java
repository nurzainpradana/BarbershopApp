...
public class StationeryOffice extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(StationeryOffice.this, 2);
    ...
    private void stationeryOffice() {
        tvTitle.setText("Perlengkapan Tulis");
        RetroConfig.getApiService(null);

        ApiInterface request = RetroConfig.retrofit.create(ApiInterface.class);
        Call<JsonRespon> call = request.getStationery();
